$path = "\\cledata\data\Common\DPW"
if (test-path $path){
	$fldracls = get-acl -path $path -Audit -AllCentralAccessPolicies
}
"Report for {0}" -f $path
"Owner:  {0}" -f $fldracls.owner
"-"*22
ForEach($acc in $fldracls.Access ){
    "{0} with file permissions of {1} " -f $acc.IdentityReference, $acc.FileSystemRights
}
# SIG # Begin signature block
# MIITlAYJKoZIhvcNAQcCoIIThTCCE4ECAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMmGELm5GuD9IIkfLZBMDMthh
# fsmggg76MIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# MBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMCMGCSqGSIb3DQEJBDEWBBSp4vtZ
# vTXGSpzoU2TrmMTI4/5+bDANBgkqhkiG9w0BAQEFAASBgA0rn+H9tjM68yE8TlVP
# KCArUKXH5KSRErAmZG1LaIoicrm2DRZNHFUhAB9t9MAfoYBgM38FuW8yucWCFVdR
# Xvx4P5t47vd/rEtteNCkZDfpcrDX4hPe0HZB8k11QAoiW6y7S5PvCSQ6qCaWgNj2
# pu4Z3jVNAY6qmQa2ytRbnNhfoYICojCCAp4GCSqGSIb3DQEJBjGCAo8wggKLAgEB
...
# BwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDgwMzA2MzQyNFowIwYJKoZIhvcNAQkEMRYE
# FAwHiPrNvz6th7/VlBUYthojejb+MIGdBgsqhkiG9w0BCRACDDGBjTCBijCBhzCB
...
# AQEFAASCAQCdCPr9lIEa5AIhxIcgXPAUIpBSh050A9kOUCDADXEEnnsbbLajrBFn
# /wgoVsxSTqZqjQSZnp2VZJaZdxglustim13oH2OMqOT5EfGp5lCxGkoKwBRC6dQC
# eh0dbvG7n1cf2WsgXXIZzQk/N34Dw4/cE8fSCEjjuRVyJLBC8OAU5LDQt1+kBpWS
# tcJzSuTaHVHVabYdz5mOmuSBYVUkCUp4g0zEYPSaJzr7sveCu7e38+jlObtbF7cG
# zyHuls0c8F1aX8HVYwjh2vZRUjXtUZNIBlUfOoZQi7sg3RtOcHhCbPNQ+2yejN0I
# +G4Yjz8BhRh/X4H9FtP3GxznePo8fIB4
